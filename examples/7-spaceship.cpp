/**
 * ----------------------------------------------------------------------------
 * A spaceship game template with sprite animation
 * ----------------------------------------------------------------------------
 */
...
struct Space {
    ...
    static const     uint8_t  STAR_LEVELS = 3;
    static constexpr uint8_t  STAR_COUNT[STAR_LEVELS] = {   32,     16,     8    };
    static constexpr uint16_t STAR_COLOR[STAR_LEVELS] = { 0x055f, 0x9eff, 0xffff };
...
struct Spaceship {
    ...
    static const uint8_t H  = 14;
    static const uint8_t Y  = 96;
    static const uint8_t VX = 2;

    static constexpr PROGMEM uint16_t SPRITE[] = {
    ...
    static const uint8_t BEAM_COUNT = 4;
